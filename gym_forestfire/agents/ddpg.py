...
class DDPG(object):
    def __init__(self, state_dim, action_dim, max_action, discount=0.99, tau=0.001, policy_noise=0.2,
                 noise_clip=0.5,
                 policy_freq=2,
        ...
        self.critic = Critic(state_dim, action_dim,image_obs=image_obs,cnn = cnn ).to(device)
    ...
    def load(self, filename):
        ...
        self.actor_target = copy.deepcopy(self.actor)
        print("files loaded successfully ddpg \n" + filename )
